...
export function old() {
  postman[Request]({
    ...
    data:
      '{\"explain\":true,\"query\":{\"bool\":{\"filter\":[{\"match\":{\"entityName\":\"Scoredetails_Reserved_Report2022041111505441962\"}},{\"match\":{\"txnAttrMapping.Scoredetails_Reserved_Report2022041111505441962.Name.values\":\"Dhoni\"}}]}}}',
    headers: {
      "User-Agent": "-t",
